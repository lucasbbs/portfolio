...
<head>
    ...
    <link href="{{ asset('backend/assets/css/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
...
<body class="sidebar-fixed sidebar-dark header-light header-fixed" id="body">
        ...
        <div class="page-wrapper">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="dropdown-header">
                                        ...
                                        <div class="d-inline-block">
                                            <span style="white-space: normal;">{{ Auth::user()->name }}</span> <small
            ...
            <footer class="footer mt-auto">
                <div class="copyright bg-white">
                    <p>
                        &copy; <span id="copy-year">2023</span> Copyright Finanzen Dashboard Bootstrap Template by
                        <a class="text-primary" href="http://www.finanzen.com/" target="_blank">lucasbbs</a>.
                    </p>
                </div>
                <script>
                    var d = new Date();
    ...
    <script src="{{ asset('backend/assets/plugins/popperjs/popper.min.js') }}"></script>
